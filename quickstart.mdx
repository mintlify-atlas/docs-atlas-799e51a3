...
<Card title="Install Reth" icon="download" href="/installation/overview">
  Get Reth running on your machine.
</Card>

<Card title="Run a node" icon="server" href="/run/overview">
  Connect to Ethereum mainnet or a testnet.
</Card>

<Card title="Developer SDK" icon="cube" href="/sdk/overview">
  Use Reth as a library to build custom nodes.
</Card>

<Card title="JSON-RPC" icon="code" href="/jsonrpc/intro">
  Query your node with the JSON-RPC API.
</Card>
